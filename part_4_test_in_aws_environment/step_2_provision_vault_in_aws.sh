...
bolt file upload 'provisioning_scripts/vault.init.sh' '/home/ubuntu/vault.init.sh' --nodes $VAULT_DNS --user 'ubuntu' --no-host-key-check
...
bolt file upload 'provisioning_scripts/vault.local.json' '/home/ubuntu/vault/config/vault.local.json' --nodes $VAULT_DNS --user 'ubuntu' --no-host-key-check
echo "upload: provisioning_scripts/vault.initialization.out.parse.sh to /home/ubuntu/vault.initialization.out.parse.sh"
bolt file upload 'provisioning_scripts/vault.initialization.out.parse.sh' '/home/ubuntu/vault.initialization.out.parse.sh' --nodes $VAULT_DNS --user 'ubuntu' --no-host-key-check
...
bolt file upload 'provisioning_scripts/provision_vault.sh' '/home/ubuntu/provision_vault.sh' --nodes $VAULT_DNS --user 'ubuntu' --no-host-key-check
